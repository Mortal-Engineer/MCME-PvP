...
public final class PVPBungee extends Plugin {
    ...
    @Getter
    public static final HashMap<UUID, List<String>> data = new HashMap<>();
    ...
    public void onEnable() {
        ...
        instance = this;
        getProxy().getPluginManager().registerListener(this, new com.mcmiddleearth.mcme.pvp.bungee.ListenerChat());
        try {
            loadAll();
